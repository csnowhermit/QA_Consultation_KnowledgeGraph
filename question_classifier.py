...
class QuestionClassifier:
    ...
    def classify(self, question):
        ...
        if not medical_dict:    # 没解析到的话，直接返回空
            return {}
    ...
    # 使用ahocorasick构建region_tree，加速做词汇匹配
    ...
    # 解析问句，得出{关键词: 类别}的对应关系
    def check_medical(self, question):
        region_wds = []
        for i in self.region_tree.iter(question):    # 使用ahocorasick构建region_tree进行词汇匹配
            wd = i[1][1]
